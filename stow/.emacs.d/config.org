     ...
     #+BEGIN_SRC emacs-lisp :tangle yes
       (use-package counsel-projectile
         ...
         :init (defhydra hydra-counsel-projectile (:color blue) "Projectile"
                 ...
                 ("g" counsel-projectile-rg "grep source")
...
** Markdown
   Make sure markdown mode is there.
   #+begin_src emacs-lisp :tangle yes
...
** Yasnippet Mode
   ...
   #+end_src
** TODO Smartpair Mode
   Could replace my electric pair config. Should be configured correctly.
   #+begin_src eomacs-lisp :tangle yes
...
** SMTP Setup
   ...
   #+BEGIN_SRC emacs-lisp :tangle no
     (setq user-mail-address "my@mail.tld"
           ...
           smtpmail-servers-requiring-authorization "smtp.office365.com" ; For office 365
